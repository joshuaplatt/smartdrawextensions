...
SitemapXMLFilter.Web.SitemapExclusion = function() {
    ...
    this.SubmitFinal = function() {
        ...
        var request = {
            ...
            success: function(data, status) {
                SDAPI.SDON.SDONDone(data, function(data, error) {    //SDone
...
SitemapXMLFilter.Web.RecentURLs = function() {
    ...
    this.Init = function() {
        SDAPI.SDON.GetUserSettings(function(response, error) {
    ...
    this.AddUrl = function(url) {
        ...
        SDAPI.SDON.GetUserSettings(function(response, error) {
            ...
            SDAPI.SDON.SetUserSettings(JSON.stringify(this.userSettings), function(success, error) {
                //maybe not needed
            }.bind(this));
...
SitemapXMLFilter.LF.SitemapFile = function() {
    ...
    this.tree.JstreeReadyCallback = function() {
        ...
        SitemapXMLFilter.LF.isExcluding = true;
    };
...
SitemapXMLFilter.LF.ClearFile = function() {
    ...
    if(SitemapXMLFilter.LF.fileInput.value) {
